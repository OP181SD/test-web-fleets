...
export const ModalRoot = ({
  ...
  return createPortal(
    // Default (sync) mode: the modal renders several children at once (overlay +
    // content), never a single keyed swap, so mode="wait" was misapplied and warned
    // "animating multiple children ... mode is set to wait".
    <AnimatePresence>
